class MembersController < ApplicationController
  ...
  def index
    ...
    case params[:users_listtype]
      when "local"
        users_scope = User.status_approved.includes(:cases).list_local(current_user)
      when "global"
        users_scope = User.status_approved.includes(:cases).list_global
      when "online"
        users_scope = User.status_approved.includes(:cases).list_online
      when "contacts"
