class Case < ActiveRecord::Base
  ...
  def self.users_index_user_feedback_chart_radar_data_all(user, interviewer, count)
    ...
    "[
      {criteria: \"Quantitative basics\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:quantitativebasics).sum.to_f/user.cases.all.count).to_s + ", 
      ...
      {criteria: \"Problem-Solving\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:problemsolving).sum.to_f/user.cases.all.count).to_s + ", 
      ...
      {criteria: \"Prioritisation\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:prioritisation).sum.to_f/user.cases.all.count).to_s + ", 
      ...
      {criteria: \"Sanity-checking\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:sanitychecking).sum.to_f/user.cases.all.count).to_s + ", 
      ...
      {criteria: \"Rapport\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:rapport).sum.to_f/user.cases.all.count).to_s + ", 
      last: " + (user.cases.where("interviewer_id = #{interviewer}").limit(count).order('id desc').collect(&:rapport).sum.to_f/count).to_s + ", 
      first: " + (user.cases.limit(count).order('id asc').collect(&:rapport).sum.to_f/count).to_s + "},
      {criteria: \"Articulation\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:articulation).sum.to_f/user.cases.all.count).to_s + ", 
      ...
      {criteria: \"Concision\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:concision).sum.to_f/user.cases.all.count).to_s + ", 
      ...
      {criteria: \"Asking for information\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:askingforinformation).sum.to_f/user.cases.all.count).to_s + ", 
      ...
      {criteria: \"Approach up front\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:approachupfront).sum.to_f/user.cases.all.count).to_s + ", 
      ...
      {criteria: \"Sticking to structure\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:stickingtostructure).sum.to_f/user.cases.all.count).to_s + ", 
      ...
      {criteria: \"Announces structure change\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:announceschangedstructure).sum.to_f/user.cases.all.count).to_s + ", 
      ...
      {criteria: \"Pusing to conclusion\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:pushingtoconclusion).sum.to_f/user.cases.all.count).to_s + ", 
  ...
  def self.users_index_user_feedback_chart_radar_data_combined(user, interviewer, count)
    ...
    "[
      {criteria: \"Interpersonal\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:interpersonal_combined).sum.to_f/user.cases.all.count).to_s + ", 
      ...
      {criteria: \"Business Analytics\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:businessanalytics_combined).sum.to_f/user.cases.all.count).to_s + ", 
      ...
      {criteria: \"Structure\", 
      all: " + (user.cases.where("interviewer_id = #{interviewer}").order('id desc').collect(&:structure_combined).sum.to_f/user.cases.all.count).to_s + ", 
