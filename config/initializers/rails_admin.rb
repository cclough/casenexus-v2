# RailsAdmin config file. Generated on November 03, 2012 18:26
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['Case', 'Country', 'Friendship', 'Notification', 'University', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Case', 'Country', 'Friendship', 'Notification', 'University', 'User']
  ...
  #     configure :status_approved, :boolean 
  #     configure :roulette_token, :string 
