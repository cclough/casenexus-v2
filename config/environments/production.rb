Casenexus::Application.configure do
  ...
  config.assets.precompile += %w( application.js posts.js books.js events.js cases.js questions.js static_pages.js map.js notifications.js console.js account.js onlinepanel.js votes.js lib/*.js application.css pdfjs.css)
