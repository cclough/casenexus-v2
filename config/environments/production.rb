Casenexus::Application.configure do
  ...
  config.assets.precompile += %w( application.js books.js events.js summary.js cases.js home.js map.js notifications.js account.js lib/*.js application.css active_admin.css active_admin.js active_admin/print.css )
